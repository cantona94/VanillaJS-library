...
export class Card extends DivComponent {
	appState: IAppState;
	cardState: any;
	constructor(appState: IAppState, cardState: any) {
		super();
	...
	#deleteFromFavorites() {
		this.appState.favorites = this.appState.favorites.filter(
			(b: any) => b.key !== this.cardState.key
		);
	}
	...
	render() {
		...
		this.el.innerHTML = `
			<div class="card__image">
				<img src="https://covers.openlibrary.org/b/olid/${this.cardState.cover_edition_key
			}-M.jpg" alt="Обложка" />
			</div>
